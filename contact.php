...
<body>
    ...
    <main>
        <!---------hero Section START ---------->
        <section class="hero-area py-5" style="background-image: url(./assets/img/conatct-bg.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-6">
                        <div class="contact__form">
                            ...
                            <div class="input__blk">
                                ...
                                <textarea class="form-control" id="contact_message" rows="5" required name="contact_message"></textarea>
                            </div>
